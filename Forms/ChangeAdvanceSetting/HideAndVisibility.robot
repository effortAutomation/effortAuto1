...
Make_InVisibility_Base_On_Emp_Group
    ...
    sleep  1s
Make_Uneditable_base_on_Emp_group
    [Arguments]  ${GroupName}
    click element  //input[@id='empgroupcheckboxEdit']
    sleep  1s
    click element   //div[@id='dual-list-box2']//li[@title='${GroupName}']/a
    sleep  1s
ok_Advance_Setting
    click element  //*[@type='button'][@text='OK']
check_field_uneditable_status
    element should be disabled  //div[@id='s2id_fields0_fieldValue']//a[@class='select2-choice']
    element should be disabled  //select[@id='fields1_fieldValue']
    element should be disabled  //select[@id='fields2_fieldValue']
    element should be disabled  //select[@id='fields3_fieldValue']
    element should be disabled  //div[@id='s2id_fields4_fieldValue']//a[@class='select2-choice']
    element should be disabled  //div[@id='s2id_fields5_fieldValue']//a[@class='select2-choice']
    element should be disabled  //select[@id='fields6_fieldValue']
    element should be disabled  //select[@id='fields7_fieldValue']
    element should be disabled  //select[@id='fields8_fieldValue']
    element should be disabled  //select[@id='fields9_fieldValue']
    element should be disabled  //select[@id='fields10_fieldValue']
    element should be disabled  //div[@id='s2id_fields11_fieldValue']//a[@class='select2-choice']
    element should be disabled  //input[@id='fields12_file']
    element should be disabled  //input[@id='fields13_file']
    element should be disabled  //input[@id='fields14_file']
    element should be disabled  //input[@id='fields15_file']
    element should be disabled  //input[@id='fields16_file']
    element should be disabled  //input[@id='fields17_fieldValue']
    element should be disabled  //input[@id='fields19_fieldValue1']
    element should be disabled  //input[@id='fields19_fieldValue2']
    element should be disabled  //input[@id='fields20_fieldValue']
    element should be disabled  //input[@id='fields21_fieldValue']
    element should be disabled  //input[@id='fields22_fieldValue']
    element should be disabled  //input[@id='fields23_fieldValue']
    element should be disabled  //input[@id='fields24_fieldValueDateTime']
    element should be disabled  //input[@id='fields25_fieldValue']
    element should be disabled  //input[@id='fields26_fieldValue']
check_field_editable_status
    element should be enabled  //div[@id='s2id_fields0_fieldValue']//a[@class='select2-choice']
    element should be enabled  //select[@id='fields1_fieldValue']
    element should be enabled  //select[@id='fields2_fieldValue']
    element should be enabled  //select[@id='fields3_fieldValue']
    element should be enabled  //div[@id='s2id_fields4_fieldValue']//a[@class='select2-choice']
    element should be enabled  //div[@id='s2id_fields5_fieldValue']//a[@class='select2-choice']
    element should be enabled  //select[@id='fields6_fieldValue']
    element should be enabled  //select[@id='fields7_fieldValue']
    element should be enabled  //select[@id='fields8_fieldValue']
    element should be enabled  //select[@id='fields9_fieldValue']
    element should be enabled  //select[@id='fields10_fieldValue']
    element should be enabled  //div[@id='s2id_fields11_fieldValue']//a[@class='select2-choice']
    element should be enabled  //input[@id='fields12_file']
    element should be enabled  //input[@id='fields13_file']
    element should be enabled  //input[@id='fields14_file']
    element should be enabled  //input[@id='fields15_file']
    element should be enabled  //input[@id='fields16_file']
    element should be enabled  //input[@id='fields17_fieldValue']
    element should be enabled  //input[@id='fields19_fieldValue1']
    element should be enabled  //input[@id='fields19_fieldValue2']
    element should be enabled  //input[@id='fields20_fieldValue']
    element should be enabled  //input[@id='fields21_fieldValue']
    element should be enabled  //input[@id='fields22_fieldValue']
    element should be enabled  //input[@id='fields23_fieldValue']
    element should be enabled  //input[@id='fields24_fieldValueDateTime']
    element should be enabled  //input[@id='fields25_fieldValue']
    element should be enabled  //input[@id='fields26_fieldValue']
